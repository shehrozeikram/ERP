...
class SardarEmployeeImporterWorking {
  constructor() {
    this.stats = {
      total: 0,
      created: 0,
  ...
  async createOrUpdateEmployee(employeeData) {
    try {
      ...
      if (existingEmployee) {
        ...
        // Create new employee using direct MongoDB insertion to bypass User model dependency
...
// Main execution
async function main() {
  const importer = new SardarEmployeeImporterWorking();
...
module.exports = SardarEmployeeImporterWorking; 